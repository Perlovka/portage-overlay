...
SRC_URI="https://github.com/arduino/Arduino/archive/${PV}.tar.gz -> ${P}.tar.gz
	...
	https://github.com/arduino-libraries/WiFi101-FirmwareUpdater-Plugin/releases/download/v0.10.6/WiFi101-Updater-ArduinoIDE-Plugin-0.10.6.zip -> ${PN}-WiFi101-Updater-ArduinoIDE-Plugin-0.10.6.zip
	doc? (
		${ARDUINO_DOCS_URI}
	)"
...
src_unpack() {
	...
	cp "${DISTDIR}/${PN}-WiFi101-Updater-ArduinoIDE-Plugin-0.10.6.zip" "${S}/build/shared/WiFi101-Updater-ArduinoIDE-Plugin-0.10.6.zip"|| die
