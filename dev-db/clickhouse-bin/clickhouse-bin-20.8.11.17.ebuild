...
SRC_URI="https://repo.clickhouse.tech/tgz/stable/clickhouse-common-static-${PV}.tgz
	server? ( https://repo.clickhouse.tech/tgz/stable/clickhouse-server-${PV}.tgz )
	client?	( https://repo.clickhouse.tech/tgz/stable/clickhouse-client-${PV}.tgz )
"
RESTRICT="primaryuri"
...
src_install() {
	...
	doins -r clickhouse-common-static-${PV}/etc
