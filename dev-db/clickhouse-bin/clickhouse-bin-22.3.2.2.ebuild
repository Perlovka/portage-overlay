...
SRC_URI="https://packages.clickhouse.com/tgz/stable/clickhouse-common-static-${PV}.tgz
	server? ( https://packages.clickhouse.com/tgz/stable/clickhouse-server-${PV}.tgz )
	client?	( https://packages.clickhouse.com/tgz/stable/clickhouse-client-${PV}.tgz )
"
RESTRICT="primaryuri"
