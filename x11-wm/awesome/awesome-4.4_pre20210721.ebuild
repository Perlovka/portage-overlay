...
if [[ ${PV} == *9999 ]] ; then
	...
	E_COMMIT_SHA="832483dd60ba194f3ae0200ab39a3a548c26e910"
...
pkg_postinst() {
	...
	elog "If your maximized window overlaps panels (wibar etc.), take a look at this bug"
	elog "https://github.com/awesomeWM/awesome/issues/3003"
}
