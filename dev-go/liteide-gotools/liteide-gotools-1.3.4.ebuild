...
"github.com/visualfc/goversion v1.0.1 h1:G+x5v9/TD4s9Ft8ARl9SX6xn41C3RNYfTMP9z3Y6GQI="
...
SRC_URI="https://github.com/visualfc/gotools/archive/refs/tags/v${PV}.tar.gz -> ${P}.tar.gz
${EGO_SUM_SRC_URI}"
